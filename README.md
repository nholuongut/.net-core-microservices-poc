...
<p align="center">
    <img alt="NET Microservices Architecture" src="https://raw.githubusercontent.com/nholuongut/dotnet-core-microservices-poc/master/readme-images/dotnetcore-microservices-architecture.png" />
</p>
...
Once there you can use Account menu item to log into the system. Valid users and passwords can be found [here] (https://github.com/nholuongut/dotnet-core-microservices-poc/blob/master/AuthService/DataAccess/InsuranceAgentsInMemoryDb.cs). You can for example login as admin with password admin.
